...
(eval (define x (define y (+ 3 7))))
; expect y

(eval (eval (define x (define y (* 9 0)))))
; expect 0
...
(begin (+ 3 5) (define x nil))
; expect x

(begin (define 1 2) (+ 4 9))
; expect Error
...
(lambda (define x 1) (nil))
; expect Error

(lambda (x) (+ x 1) (1))
; expect (lambda (x) (+ x 1) (1))
...
(define haha (lambda (lol lmao) (hehe (+ lol lol))))
;expect haha

(define hehe (mu (lol) (+ lol lmao)))
;expect hehe
